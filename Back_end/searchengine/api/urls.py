...
urlpatterns = [
    ...
    path('recruiment/main/page/<int:page>/', cache_page(60 * 10)(MainPageRecruiment.as_view()), name='recruiment_main_page'),
    path('application/main/page/', ApplicationsMainPage.as_view(), name='application_main_page'),
